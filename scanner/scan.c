     ...
     switch (state) {
      ...
      { state = DONE;
        ...
        { case EOF:
            ...
            break;
          case '+': currentToken = SOM;     break;
          case '-': currentToken = SUB;    break;
          case '*': currentToken = MUL;    break;
          case '(': currentToken = APR;   break;
          case ')': currentToken = FPR;   break;
          case '[': currentToken = ACL; break;
          case ']': currentToken = FCL; break;
          case '{': currentToken = ACH;   break;
          case '}': currentToken = FCH;   break;
          case ';': currentToken = PEV;     break;
          case ',': currentToken = VIR;    break;
          default:  currentToken = ERR;    break;
        }
      }
      break;
